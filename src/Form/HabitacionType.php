...
class HabitacionType extends AbstractType
{
    ...
    {
        $builder
            ->add('Numero', IntegerType::class, ["label"=> "Numero de Habitacion ", 
                'constraints' => [
                    new Range(['min' => 101, 'max' => 999])
                ],
                'attr' =>['placeholder' => 'Primer nº: Bloque    Segundo nº: Planta     Tecer nº: Habitacion         (Ej: 348, Bloque:3, Planta:4, Puerta:8) '],
